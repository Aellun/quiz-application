...
class createuserform(UserCreationForm):
    class Meta:
        model = User  # Specify the model to use (User model)
...
# Custom form for adding questions, inheriting from ModelForm
class addQuestionform(forms.ModelForm):
    class Meta:
        model = QuesModel  # Specify the model to use (QuesModel)
